...
public class frutamagica extends fruta {
	...
	//Repito los atributos en las clases para evitar cualquier posible confusión con los de otras clases
	...
	public frutamagica(int posicionX, int posicionY, int ancho, int alto, char simbolo, String imagen) {
		...
		switch(simbolo) {
		//Dependiendo de que fruta mágica sea le damos unos valores y efecto:
		case 'G':
			this.nombre="Dorada";
			this.puntos=300;
			this.efecto="Correr";
